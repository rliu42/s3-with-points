...
var computeTally = function(mail_data, current_tally) {
...
exports.computeTally = computeTally;
...
var bulkTally = function() {
    tallyRef.once("value", function(ss) {
        ...
        mailRef.once("value", function(ss) {
            ...
            current_tally = computeTally(mail_data, current_tally);
